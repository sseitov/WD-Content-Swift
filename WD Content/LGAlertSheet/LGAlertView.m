...
/**
 *  Use this method if you want to initialize a basic alert view with a vertical layout of buttons
 *  without a textField and customize it your own way before shown
 */
+ (LGAlertView *)verticalAlertWithTitle:(NSString *)title
                                message:(NSString *)message
                      cancelButtonTitle:(NSString *)cancelButtonTitle
                       otherButtonTitle:(NSString *)otherButtonTitle
                      cancelButtonBlock:(LGAlertViewCancelBlock)cancelButtonBlock
    ...
    return [LGAlertView alertWithTitleImage:nil
                          ...
                          cancelButtonBlock:cancelButtonBlock
                           otherButtonBlock:otherButtonBlock
                              buttonsLayout:LGASButtonsLayoutVertical];
}

/**
 *  Initialize an alert view with a vertical layout of buttons without a textField and show
 */
+ (void)showVerticalAlertWithTitle:(NSString *)title
                 ...
                 cancelButtonBlock:(LGAlertViewCancelBlock)cancelButtonBlock
                  otherButtonBlock:(LGAlertViewOtherBlock)otherButtonBlock {
    LGAlertView *alert = [LGAlertView verticalAlertWithTitle:title
                                                     message:message
                                           cancelButtonTitle:cancelButtonTitle
                                            otherButtonTitle:otherButtonTitle
                                           cancelButtonBlock:cancelButtonBlock
...
+ (LGAlertView *)alertWithTitleImage:(UIImage *)titleImage
                   ...
                   cancelButtonBlock:(LGAlertViewCancelBlock)cancelButtonBlock
                    otherButtonBlock:(LGAlertViewOtherBlock)otherButtonBlock {
    return [LGAlertView alertWithTitleImage:titleImage
                                      title:title
                                    message:message
                          cancelButtonTitle:cancelButtonTitle
                           otherButtonTitle:otherButtonTitle
                          cancelButtonBlock:cancelButtonBlock
                           otherButtonBlock:otherButtonBlock
                              buttonsLayout:LGASButtonsLayoutHorizontal];
}
...
+ (LGAlertView *)alertWithTitleImage:(UIImage *)titleImage
                   ...
                   cancelButtonBlock:(LGAlertViewCancelBlock)cancelButtonBlock
                    otherButtonBlock:(LGAlertViewOtherBlock)otherButtonBlock
                       buttonsLayout:(LGASButtonsLayout)buttonsLayout {
    NSString *nibName = buttonsLayout == LGASButtonsLayoutHorizontal ? @"LGAlertView" : @"LGVAlertView";
    LGAlertView *alert = [[[NSBundle mainBundle] loadNibNamed:nibName owner:nil options:nil] firstObject];
...
- (void)dismiss {
    if (self.popoverHostController) {
        [self.popoverHostController dismissViewControllerAnimated:YES completion:^{
